...
int Crystal_Clear_main(int argc, char* argv[]) {
    ...
    GBConfig runtime_config = *Crystal_Clear_default_config();
    ...
    if (differential_mode) {
        ...
        gb_context_set_save_id(generated_ctx, "Crystal_Clear");
        gb_context_set_save_id(interpreted_ctx, "Crystal_Clear");
        Crystal_Clear_init(generated_ctx);
        Crystal_Clear_init(interpreted_ctx);
    ...
    gb_context_set_save_id(ctx, "Crystal_Clear");
...
int main(int argc, char* argv[]) {
    return Crystal_Clear_main(argc, argv);
}
